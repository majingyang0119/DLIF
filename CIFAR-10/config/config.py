...
parser.add_argument('--arch', default='VGG16', type=str, help='VGG5|VGG9|VGG13|VGG16|VGG19|CIFAR')
...
parser.add_argument('--dts_cache', type=str, default='/home/kairongyu/kd-snn/experiment/cifar10dvs/dts_cache')
